				...
				<li class="nav-item menu-items"><a class="nav-link"
					...
					<div class="collapse" id="ui-basic">
						<ul class="nav flex-column sub-menu">
							<li class="nav-item"><a class="nav-link" href="/curd-sanpham">CURD
									Sản phẩm</a></li>
				...
				<li class="nav-item menu-items"><a class="nav-link"
					...
					<div class="collapse" id="auth">
						<ul class="nav flex-column sub-menu">
							...
							<li class="nav-item"><a class="nav-link" href="/tk-nguoidung">Thống
									kê người dùng</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/tksp-nguoidung">Người theo sản phẩm </a></li>
							<li class="nav-item"><a class="nav-link" href="/ht-nguoidung">Hiển
									thị người dùng</a></li>
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<h1 class="text-center text-light mb-3">Thêm sửa xóa Khách
						hàng</h1>
					<form:form action="admin/khachkang" method="post" class="m-1"
						...
						<div class="d-flex">
							<div class="col-5">
								...
								<input type="file" name="khachHangImg" class="text-light mt-1">
							</div>
							<div class="col-4 m-1">
								<div class="">
									...
									<label for="exampleInputEmail1" class="form-label text-light">Địa
										chỉ</label>
									<form:input type="text" path="diaChi"
										class="form-control text-light" />
									<label for="exampleInputEmail1" class="form-label text-light">Họ
										tên</label>
									...
									<div class="form-check form-check-inline mt-3 text-light">
										<form:radiobuttons class="form-check-input m-2" path="chucNang"
											items="${chucnang}" delimiter="" />
							...
							<div class="col-3 m-1">
								<div class="">
									<label for="exampleInputEmail1" class="form-label text-light">Mật
										khẩu</label>
									<form:password path="matKhau" class="form-control text-light" />

									<label for="exampleInputEmail1" class="form-label text-light">Số
										điên thoại</label>
									<form:input path="soDienThoai" class="form-control text-light" />
								</div>

							</div>
						</div>
						<div class="d-flex justify-content-around col-12 m-5">
							<button formaction="/admin/khachhang/taoKhachHang"
								class="btn btn-success btn-primary">Tạo khách hàng</button>
							<button formaction="#" class="btn btn-primary ">Cập
								nhật khách hàng</button>
							<button formaction="#" class="btn btn-warning text-light">Làm
								sạch</button>
							<button formaction="#" class="btn btn-danger">Xóa khách
								hàng</button>
								<a href="/ht-nguoidung" class="btn btn-info ">Hiển thị sản phẩm</a>
						</div>
					</form:form>
				</div>
