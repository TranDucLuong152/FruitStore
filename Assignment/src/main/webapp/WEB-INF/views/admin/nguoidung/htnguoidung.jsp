   ...
   <nav class="sidebar sidebar-offcanvas" id="sidebar">
						...
						<div class="profile-pic">
							<div class="count-indicator">
								<img class="img-xs rounded-circle"
									src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-fruit-shop-logo-template-designs-fresh-fruit-center-logo-template-designs-png-image_5292681.jpg" alt="" /> <span
						...
						<li class="nav-item dropdown"><a class="nav-link"
							id="profileDropdown" href="#" data-toggle="dropdown">
								<div class="navbar-profile">
									<img class="img-xs rounded-circle"
										src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-fruit-shop-logo-template-designs-fresh-fruit-center-logo-template-designs-png-image_5292681.jpg" alt="" />
       ...
       <div class="main-panel">
          <div class="content-wrapper">
					<h1 class="text-center text-light">Hiển thị sản phẩm</h1>
					<div>
					...
					<div class="m-3">
						<table class="table table-hover table-dark">
							...
							<tbody>
								<c:forEach items="${htNguoiDung}" var="item">
									<tr>
										...
										<td>${item.chucNang}</td>
										<td>${item.ngayTao}</td>
										<td><a class="btn btn-primary btn-sm" href="/admin/khachhang/edit?editKhachHang&idKH=${item.tenTaiKhoan}">edit</a><a class="btn btn-danger btn-sm" href="/admin/khachhang/del?delKhachHang&idKH=${item.tenTaiKhoan}">del</a></td>
