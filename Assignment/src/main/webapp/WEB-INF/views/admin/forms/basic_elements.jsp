      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
			...
			<ul class="nav">
					...
					<div class="profile-desc">
						<div class="profile-pic">
							...
							<div class="profile-name">
								<h5 class="mb-0 font-weight-normal">Trần Đức Lượng</h5>
								<span>Admin</span>
							</div>
						</div>
				...
				<li class="nav-item menu-items"><a class="nav-link"
					...
					aria-controls="ui-basic"> <span class="menu-icon"> <i
							class="mdi mdi-laptop"></i>
					</span> <span class="menu-title">Cửa hàng</span> <i
						class="menu-arrow"></i>
				</a>
					<div class="collapse" id="ch-basic">
						<ul class="nav flex-column sub-menu">
							<li class="nav-item"><a class="nav-link"
								href="curd-cuahang">CURD Cửa hàng</a></li>
							<li class="nav-item"><a class="nav-link"
								href="ht-cuahang">Hiển thị Cửa hàng</a></li>
							<li class="nav-item"><a class="nav-link"
								href="tk-cuahang">Thống kê Cửa hàng</a></li>
						</ul>
					</div></li>
