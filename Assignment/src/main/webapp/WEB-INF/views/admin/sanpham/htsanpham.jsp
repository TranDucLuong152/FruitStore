				...
				<div class="content-wrapper">
					...
					<div class="m-3">
						<table class="table table-hover table-dark">
							...
							<tbody>
								<c:forEach items="${htSanPham}" var="item">
									<tr>
										...
										<td>${item.urlHinhAnh}</td>
										<td>${item.moTa}</td>
										<td>${item.ngayTao}</td>
										<td><a class="btn btn-primary btn-sm" href="/admin/sanpham/edit?editSanPham&idSP=${item.maSanPham}">edit</a><a class="btn btn-danger btn-sm" href="/admin/sanpham/del?delSanPham&idSP=${item.maSanPham}">del</a></td>
